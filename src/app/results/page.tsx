...
function ModuleAccordion({
  ...
  const inject = (t: string) => t.replace("{words}", String(words));
      ...
      <div className="w-full max-w-3xl py-4">
        ...
        <div className="mt-7">
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link href="/register" className="btn-primary flex-1 rounded-full px-6 py-4 text-center text-sm">
              {qt(locale, "startPrep")} →
            </Link>
            <Link href="/quiz" className="btn-ghost flex-1 rounded-full px-6 py-4 text-center text-sm font-medium">
              {qt(locale, "retake")}
            </Link>
          </div>
