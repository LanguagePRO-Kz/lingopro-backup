...
const DESCRIPTION =
  "Пройдите AI-диагностику турецкого языка, получите персональный план подготовки к TÖMER на 30/60/90 дней и занимайтесь с AI-преподавателем для поступления в университет Турции.";
